    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg flex flex-col gap-y-5">
                ...
                <div class="flex frex-row justify-between items-center mb-5">
                    <h3 class="text-indigo-950 font-bold text-2xl">Overview</h3>                    
                </div>

                <div class="flex frex-row justify-between">
                    <div>
                        <p class="text-slate-500 font-bold text-sm">Total Product :</p>
                        <p class="text-indigo-950 font-bold text-xl">{{count($my_products)}}</p>
                    </div>
                    
                    <div>
                        <p class="text-slate-500 font-bold text-sm">Total Order :</p>
                        <p class="text-indigo-950 font-bold text-xl">{{count($total_order_success)}}</p>
                    </div>

                    <div>
                        <p class="text-slate-500 font-bold text-sm">Total Revenue :</p>
