...
class ProductController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try{
            ...
            if($request->hasFile('path_file')){
                $path_filePath = $request->file('path_file')->store('product_path_files', 'public');
    ...
    public function destroy(Product $product)
    {
        ...
        try{
            $product->delete();
            return redirect()->route('admin.products.index')->with('success', 'Product delete successfuly!');
        }
        catch(\Exception $e){
